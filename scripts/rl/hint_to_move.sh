...
ACTOR_DTYPE=fp32
EXP_NAME=uitars-bs32n12-hint-to-move # debug # bs32n12
...
--config-name=default_config \
 ...
 max_times_to_make_a_batch=10 \
 custom_reward_function.path=./cursor/rl/reward_funcs.py \
 custom_reward_function.name=calculate_rewards \
 custom_reward_function.reward_kwargs.format_function_name=uitars_format_reward \
 ...
 actor_rollout_ref.model.path=/mnt/ceph_rbd/models/ByteDance-Seed/UI-TARS-1.5-7B \
 ...
 cursor.system_prompt_format_path=cursor/prompts/uitars_no_system_prompt.txt \
 cursor.first_turn_prompt_format_path=cursor/prompts/uitars_query_prompt.txt \
 cursor.action_extractor_fn_name=uitars_action \
 ...
 trainer.resume_from_path=/mnt/ceph_rbd/GUI-Cursor-Moving/checkpoints/GUI-Cursor/uitars-bs32n12/global_step_100 \
